...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <img width="50" height="50" src="https://img.icons8.com/ios-filled/50/hacking.png" alt="hacking"/>
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Fraudy</span>
    </a>
